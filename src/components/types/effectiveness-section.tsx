...
export function EffectivenessSection({ type, typeColor }: Props) {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h2 className="font-press-start text-[13px] text-[#111111] mb-2">EFECTIVIDADES</h2>

                {/* Separador doble con animaciones de escala */}
                ...
                <p className="font-nunito text-[12px] text-[#888888]">
                    Los multiplicadores dependen del tipo del atacante
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* COLUMNA: ATACA */}
                <div>
                    <div className="bg-[#111111] px-4 py-2.5 flex items-center gap-2 mb-4 relative" style={{ boxShadow: "3px 3px 0 #CC0000" }}>
                        <Swords size={14} className="text-white" />
                        <span className="font-nunito text-[12px] font-bold text-white uppercase">{typeNameES} ATACA...</span>
                    </div>

                    <div className="bg-[#FAFAFA] border-2 border-[#111111] p-5 space-y-6">
                        <EffectivenessGroup
    ...
    return (
        <div>
            <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-press-start text-[8px]" style={{ color }}>{title}</h3>
            </div>
